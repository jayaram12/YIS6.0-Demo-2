...
;(function($, window, document, undefined) {
  ...
  $.fn.imageuploadify = function(opts) {
    ...
    this.each(function() {
      ...
      let dragbox = $(`
      <div class="imageuploadify well MarginTop20">
        ...
        <div class="ImageUpload clearfix">
          ...
          <div class="col-md-12 text-center center-block MarginBottom20">
            <button type="button" class="btn btn-custom MarginTop20">or select file to upload</button>
          </div>
          </div>
        </div>
      </div>
      ...
      const readingFile = (id, file) => {
        ...
        let container = $(`<div class='imageuploadify-container col-md-12 MarginTop20'>
